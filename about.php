...
<!-- Mirrored from nouthemes.net/html/chikery/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jun 2022 08:40:11 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <title>About page</title><link href="https://fonts.googleapis.com/css?family=Cormorant+Garamond:300i,400,400i,500,500i,600,600i,700&amp;display=swap" rel="stylesheet">
    ...
    <div class="ps-page--about">
      <div class="ps-hero bg--cover" data-background="img/hero/shop-hero.png">
        <div class="ps-hero__container">
          ...
          <h1 class="ps-hero__heading">About Us
            ...
            <div class="row">
              <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 ">
                <div class="ps-block--award">
                  <div class="ps-block__header"><img src="" alt="">
                    <h4>SWEET OF THE YEAR</h4>
                    <p>2021</p>
                  </div>
                  <div class="ps-block__content">
                    <p>Our sweet Jalebi had won the award for the sweet of the year competition held in Carstreet, Mangalore.</p>
                  </div>
                </div>
              </div>
              <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 ">
                <div class="ps-block--award">
                  ...
                  <div class="ps-block__content">
                    <p>We had won the prize for the best sweets competition held in Manipal.</p>
                  </div>
                </div>
              </div>
              <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 ">
                <div class="ps-block--award">
                  ...
                  <div class="ps-block__content">
                    <p>Most of our sweets got the First spot in the sweets expo at Mangalore.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 ">
              <div class="ps-section__header">
                <p>WELCOME TO SWEET GALORE</p>
                <h3>SWEET GALORE</h3><i class="chikery-tt1"></i>
              </div>
              <div class="ps-section__content">
                <p>“In India, sweets are more than just a treat, they hold cultural and religious significance and are a symbol of hospitality, love, and joy. From weddings to pujas and from get-togethers to festivals, sweets are a ubiquitous presence and are an essential part of the Indian way of life. Regional sweets of India belong to innumerable categories, and vary according to the Indian states, towns and districts. Numerous portions of Northern Indian, Western India, Southern India, Central India and Eastern India are renowned for their indigenous sweets and sweet dishes. Indians are said to possess a sweet tooth and they cannot be blamed, as many regions of India manufacture delectable sweets which are utilized as 'desserts'. Regional sweets of India are available in manifold shapes, sizes, colours and flavours. Ingredients like milk, milk products like 'ghee', cottage cheese and others, rice, flour, legumes, dry fruits and many others are used to prepare Indian sweets.”</p>
                <div class="ps-section__image"><img src="" alt=""></div>
                <h5><span>NIFAN</span> - SWEET GALORE</h5>
              </div>
            </div>
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 ">
              <div class="ps-section__image"><img src="simages/mo.jpg" alt=""></div>
            </div>
          </div>
        </div>
      </div>
      <div class="ps-section ps-home-best-services">
        <div class="ps-section__left bg--cover" data-background="simages/Roll.png"></div>
        <div class="ps-section__right">
          <div class="ps-section__container">
            ...
            <div class="ps-section__content">
              <p>India not only has a rich cultural history, its association with sweets is also millennia old. Indians were the first to refine sugar, at around 500 BC and by 300 BC, five different kinds of sugar were being processed in India. The oldest reference to Jalebi was made in the 13th century.</p>
              <ul>
                <li>BEST QUALITY</li>
          ...
          <div class="ps-section__image bg--cover" data-background="simages/ra.jpg"></div>
        </div>
      </div>
...
<!-- Mirrored from nouthemes.net/html/chikery/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jun 2022 08:40:36 GMT -->
</html>