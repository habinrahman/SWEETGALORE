    ...
    <div class="ps-page--contact">
        <div class="ps-hero bg--cover" data-background="img/hero/shop-hero.png">
            <div class="ps-hero__container">
                ...
                <h1 class="ps-hero__heading">Track order</h1>
            </div>
        </div>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <button type="button" id="shopGetOrderStatusID" class="btn btn-success">Get status</button>
                            ...
                            $stmt4 = $admin->ret("SELECT  * FROM `order_details` INNER  JOIN  `shippingdetails` ON shippingdetails.o_id=order_details.o_id WHERE order_details.c_id='$id'");
                            $i = 0;
                            ...
                            ?>
                                ...
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        <span class="prefix">Date order:</span>
                                        <span class="label label-success"><?php echo $stmt5['date'] ?></span>
                                    </li>
                                    <li class="list-group-item">
                                        <span class="prefix">Total quantity:</span>
                                        <span class="label label-success"><?php echo $stmt5['o_quantity'] ?></span>
                                    </li>
                                    <li class="list-group-item">
                                        <span class="prefix">Total amount:</span>
                                        <span class="label label-success"><?php echo $toatl=$stmt5['o_quantity']*$stmt2['price'] ?></span>
                                    </li>
                                    <li class="list-group-item">
                                    <span class="prefix">Shipping address:</span>
                                   <?php echo $stmt5['name'] ?><?php echo $stmt5['address'] ?><?php echo $stmt5['zip_code'] ?></a></li>
                                </ul>

                                <div class="order-status">
                                <div class="order-status-timeline">
                                        
                                        <div class="order-status-timeline-completion c"></div>
                                    </div>
                                    
                                    <?php if ($stmt5['status'] == 0) { ?>
                                        <div class="order-status-timeline">
